...
def save_classification_report(labels, predictions):
    ...
    save_path = REPORT_DIR / "classification_report.txt"
...
def main():
    ...
    # İlk aşamada ana katmanları donduruyoruz.
    # Sadece son sınıflandırma katmanını eğitiyoruz.
    ...
    for epoch in range(EPOCHS):
        ...
        if valid_acc > best_valid_acc:
            ...
            print("En iyi model kaydedildi:", save_path)
